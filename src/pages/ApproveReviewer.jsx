...
const ApproveReviewers = () => {
    const { reviewers, fetchReviewers, areaEditor, fetchApprovedReviewers, approval } = useContext(contextProviderDeclare);
                                                ...
                                                {hasMatchingSubjectArea(reviewer) && (
                                                    isSelfReviewer(reviewer) ? (
                                                        <Button 
                                                            ...
                                                            size="sm"
                                                            disabled
                                                            title="Cannot approve your own reviewer profile"
                                                        >
